...
const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        longDescription: 'Beat Saber-inspired web game where you slice flying blocks in rhythm with music! Built with React, Vite, and TypeScript for optimal performance. Features smooth animations and responsive controls.',
