...
interface ProfileCardProps {
    ...
    /** Custom message to show in user info area instead of user details */
                        ...
                        <div className="pc-content pc-avatar-content">
                            ...
                            {showUserInfo && (
                                <div className="pc-user-info">
                                    {bottomMessage ? (
                                        /* Custom bottom message mode */
                                        <div className="pc-bottom-message">
                                            <span className="pc-bottom-icon">👆</span>
                                            <span className="pc-bottom-text">{bottomMessage}</span>
                                        </div>
                                    ) : (
                                        /* Default user info mode */
                                        <>
